    ...
    <div className="container">
      ...
      >
        ...
        <div className="text-protect" style={{ display: 'flex', gap: '2rem', marginTop: '6rem', justifyContent: 'center', position: 'relative', zIndex: 20 }}>
            <a href="/projects" style={{ padding: '1.2rem 4rem', fontSize: '1.2rem', background: 'rgba(56, 189, 248, 0.15)', backdropFilter: 'blur(10px)', color: '#ffffff', textShadow: '0 0 8px rgba(255,255,255,0.6)', borderRadius: '20px', border: '1px solid rgba(226, 232, 240, 0.4)', textDecoration: 'none', fontWeight: '800', display: 'inline-block', transition: 'all 0.1s', boxShadow: '0 6px 0 #94a3b8, 0 6px 0 2px #0ea5e9, 0 15px 25px rgba(0,0,0,0.6), inset 0 1px 3px rgba(255,255,255,0.3)' }} onMouseOver={(e) => { e.currentTarget.style.transform = 'translateY(3px)'; e.currentTarget.style.boxShadow = '0 3px 0 #94a3b8, 0 3px 0 2px #0ea5e9, 0 8px 15px rgba(0,0,0,0.6), inset 0 1px 3px rgba(255,255,255,0.3)' }} onMouseOut={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 6px 0 #94a3b8, 0 6px 0 2px #0ea5e9, 0 15px 25px rgba(0,0,0,0.6), inset 0 1px 3px rgba(255,255,255,0.3)' }}>Explore</a>
            <a href="/query" style={{ padding: '1.2rem 4rem', fontSize: '1.2rem', background: 'rgba(56, 189, 248, 0.15)', backdropFilter: 'blur(10px)', color: '#ffffff', textShadow: '0 0 8px rgba(255,255,255,0.6)', borderRadius: '20px', border: '1px solid rgba(226, 232, 240, 0.4)', textDecoration: 'none', fontWeight: '800', display: 'inline-block', transition: 'all 0.1s', boxShadow: '0 6px 0 #94a3b8, 0 6px 0 2px #0ea5e9, 0 15px 25px rgba(0,0,0,0.6), inset 0 1px 3px rgba(255,255,255,0.3)' }} onMouseOver={(e) => { e.currentTarget.style.transform = 'translateY(3px)'; e.currentTarget.style.boxShadow = '0 3px 0 #94a3b8, 0 3px 0 2px #0ea5e9, 0 8px 15px rgba(0,0,0,0.6), inset 0 1px 3px rgba(255,255,255,0.3)' }} onMouseOut={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 6px 0 #94a3b8, 0 6px 0 2px #0ea5e9, 0 15px 25px rgba(0,0,0,0.6), inset 0 1px 3px rgba(255,255,255,0.3)' }}>Request</a>
        </div>
